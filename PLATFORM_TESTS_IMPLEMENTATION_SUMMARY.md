...
### 4. run_platform_tests.sh (200 lines)
**Location**: `/Users/rcurrie/src/brix-cache/tests/platform/run_platform_tests.sh`
...
| `run_platform_tests.sh` | 200 | Test runner script |
...
- Check `tests/platform/README.md`
