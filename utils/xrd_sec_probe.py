...
# Concurrency probes live in a continuation shard to keep this file under the
# 600 logical-line cap; exec'd into this module's globals so their @probe
# decorators register into PROBES and they can call the helpers above.
exec(compile(open(os.path.join(os.path.dirname(os.path.abspath(__file__)),
     "xrd_sec_probe_ext.py")).read(), "xrd_sec_probe_ext.py", "exec"))
