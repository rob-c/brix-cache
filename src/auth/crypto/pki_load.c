/*
 * pki_load.c — PEM certificate and CRL loaders for the startup PKI
 * consistency checks.  Loads X509 / X509_CRL stacks from either a single PEM
 * file or a Grid-CA directory (hash.r0/.r1 CRLs, dot-prefixed helpers skipped),
 * logging at WARN rather than aborting.  Each function is documented at its
 * definition below.
 */
