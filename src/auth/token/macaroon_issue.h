#ifndef BRIX_TOKEN_MACAROON_ISSUE_H
#define BRIX_TOKEN_MACAROON_ISSUE_H
 ...
 */
#define BRIX_MACAROON_ISSUE_OUT_MAX  1024

/*
 * brix_macaroon_issue — mint a new single-root WLCG macaroon.
 *
 ...
 *   root_key     HMAC root key bytes (obtain via brix_macaroon_secret_parse)
 ...
 *   out_b64sz    size of out_b64 (must be >= BRIX_MACAROON_ISSUE_OUT_MAX)
 *
 * Returns NGX_OK on success, NGX_ERROR on any failure.
 */
ngx_int_t brix_macaroon_issue(ngx_log_t *log,
...
#endif /* BRIX_TOKEN_MACAROON_ISSUE_H */
