 ...
 *      range outcome, PUT body mode, TPC event, CORS decision, PROPFIND depth). brix_export_webdav_metrics()
 ...
 * BRIX_WEBDAV_* enum so the SHM counter slot and its Prometheus label string
 ...
 */
static const char *brix_webdav_method_names[BRIX_WEBDAV_NMETHODS] = {
    "OPTIONS",
    "HEAD",
    "GET",
    "PUT",
...
static const char *brix_webdav_auth_names[BRIX_WEBDAV_NAUTH_RESULTS] = {
    "none",
    "cert_ok",
    "token_ok",
    "anonymous_fallback",
...
static const char *brix_webdav_propfind_depth_names[
    BRIX_WEBDAV_NPROPFIND_DEPTHS] =
{
    "0",
    "1",
    "infinity",
...
static const char *brix_webdav_tpc_names[BRIX_WEBDAV_NTPC_EVENTS] = {
    "pull_started",
    "pull_success",
    "curl_started",
    "curl_success",
...
static const char *brix_webdav_cors_names[BRIX_WEBDAV_NCORS_EVENTS] = {
    "no_origin",
    "allowed",
    "denied",
    "preflight",
...
static const char *brix_webdav_tpc_cred_names[BRIX_WEBDAV_NTPC_CRED_EVENTS] = {
    "started",
    "success",
    "error",
    "unknown_mode",
 ...
 */
void
brix_export_webdav_metrics(metrics_writer_t *mw,
    ngx_brix_metrics_t *shm)
{
    ...
    mw_emit_labeled(mw,
        ...
        "method",
        brix_webdav_method_names, BRIX_WEBDAV_NMETHODS,
    ...
    mw_printf(mw,
        "# HELP brix_webdav_responses_total "
            "WebDAV responses by method and HTTP status class.\n"
        "# TYPE brix_webdav_responses_total counter\n");
    for (method = 0; method < BRIX_WEBDAV_NMETHODS; method++) {
        for (status = 0; status < BRIX_HTTP_NSTATUS; status++) {
            mw_printf(mw,
                "brix_webdav_responses_total"
                    "{method=\"%s\",status_class=\"%s\"} %lu\n",
                brix_webdav_method_names[method],
    ...
    mw_emit_labeled(mw,
        ...
        "result",
        brix_http_range_result_names, BRIX_WEBDAV_NRANGE_RESULTS,
    ...
    mw_emit_labeled(mw,
        ...
        "mode",
        brix_webdav_put_names, BRIX_WEBDAV_NPUT_MODES,
    ...
    mw_emit_labeled(mw,
        ...
        "depth",
        brix_webdav_propfind_depth_names, BRIX_WEBDAV_NPROPFIND_DEPTHS,
    ...
    mw_emit_labeled(mw,
        ...
        "event",
        brix_webdav_tpc_names, BRIX_WEBDAV_NTPC_EVENTS,
    ...
    mw_emit_labeled(mw,
        ...
        "event",
        brix_webdav_cors_names, BRIX_WEBDAV_NCORS_EVENTS,
    ...
    mw_emit_labeled(mw,
        ...
        "event",
        brix_webdav_tpc_cred_names, BRIX_WEBDAV_NTPC_CRED_EVENTS,
