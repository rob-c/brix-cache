...
#define BRIX_WEBDAV_METHOD_MOVE     8
#define BRIX_WEBDAV_METHOD_OTHER    9
#define BRIX_WEBDAV_NMETHODS        10
...
#define BRIX_WEBDAV_AUTH_RESULT_PWD_OK     5
#define BRIX_WEBDAV_NAUTH_RESULTS          6
