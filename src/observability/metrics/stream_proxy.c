 ...
 * HOW: XROOTD_EXPORT_PROXY_COUNTER macro generates HELP/TYPE/value lines for each metric family. Iterates server
...
void
xrootd_export_stream_proxy_metrics(metrics_writer_t *mw,
