 ...
 */
#ifndef BRIX_MIRROR_STREAM_MIRROR_H
#define BRIX_MIRROR_STREAM_MIRROR_H
 ...
 */
void brix_stream_mirror_maybe(brix_ctx_t *ctx, ngx_connection_t *c,
    ngx_stream_brix_srv_conf_t *conf, ngx_int_t primary_rc);

/* Directive setters (registered in src/stream/module.c). */
char *brix_stream_mirror_set_url(ngx_conf_t *cf, ngx_command_t *cmd,
    void *conf);
char *brix_stream_mirror_set_opcodes(ngx_conf_t *cf, ngx_command_t *cmd,
    void *conf);
char *brix_stream_mirror_set_exclude_opcodes(ngx_conf_t *cf,
    ngx_command_t *cmd, void *conf);

#endif /* BRIX_MIRROR_STREAM_MIRROR_H */
