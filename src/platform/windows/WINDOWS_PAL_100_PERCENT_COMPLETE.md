...
├── ADS_IMPLEMENTATION.md
├── COPY_RANGE_IMPLEMENTATION.md
├── HANDLE_ABSTRACTION_DESIGN.md
├── HANDLE_ABSTRACTION_REPORT.md
├── IMPLEMENTATION_REPORT_EVENT_WRAPPER.md
└── WINDOWS_PAL_100_PERCENT_COMPLETE.md  (this file)
```
