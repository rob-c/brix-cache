 ...
 *
 * WHAT: brix_xfer_finish() — the single call every transfer kind makes when it
 ...
 *       writethrough_flush.c) built an brix_xfer_audit_t inline and called the
