 ...
 *       remove, and child_count. Each is one prepared statement (creates and puts
 *       gate the parent first); the namespace cache is consulted on read and
 *       invalidated/installed on write.
 *
