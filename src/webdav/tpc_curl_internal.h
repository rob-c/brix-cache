 ...
 */
#ifndef XROOTD_TPC_CURL_INTERNAL_H
...
/* tpc_curl.c */
ngx_int_t webdav_tpc_run_curl_core(ngx_log_t *log, ngx_http_xrootd_webdav_loc_conf_t *conf, ngx_array_t *transfer_headers, int is_push, const char *file_path, const char *url, const char *log_tag, uint64_t transfer_id);
...
#endif /* XROOTD_TPC_CURL_INTERNAL_H */
