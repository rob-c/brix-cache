 ...
 *
 *   directive_name  NUL-terminated directive name for error messages (e.g. "xrootd_root")
...
/*
 * xrootd_prepare_export_root — validate and canonicalize an export root path.
 *
 ...
 *   4. Calls xrootd_validate_path() to verify the path is a readable directory
