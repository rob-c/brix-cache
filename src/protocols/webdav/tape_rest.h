 ...
 * dispatch.c routes /api/v1/ requests here when brix_webdav_tape_rest is on.
 */

#ifndef NGX_BRIX_WEBDAV_TAPE_REST_H
#define NGX_BRIX_WEBDAV_TAPE_REST_H
...
#endif /* NGX_BRIX_WEBDAV_TAPE_REST_H */
