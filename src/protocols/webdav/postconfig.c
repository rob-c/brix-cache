...
ngx_http_brix_webdav_postconfiguration(ngx_conf_t *cf)
{
    ...
    *h = ngx_http_brix_webdav_access_handler;
    ...
    *h = brix_http_mirror_precontent_handler;
    ...
    *h = brix_http_mirror_log_handler;
