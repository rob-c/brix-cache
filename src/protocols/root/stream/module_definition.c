...
ngx_module_t ngx_stream_brix_module = {
   ...
   * identity broker when brix_impersonation=map; a no-op otherwise. */
    NULL,                                   /* init master        */
