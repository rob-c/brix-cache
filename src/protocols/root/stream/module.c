...
/* phase-64: brix_stage_flush sync|async value map (0 = sync, 1 = async). */
static ngx_conf_enum_t  brix_stage_flush_enum[] = {
    { ngx_string("sync"),  0 },
    { ngx_string("async"), 1 },
    { ngx_null_string,     0 }
};

/* phase-64: brix_cache_meta map (BRIX_CMETA_* in cache/cstore.h). */
static ngx_conf_enum_t  brix_cache_meta_enum[] = {
    { ngx_string("auto"),    0 },
    { ngx_string("local"),   1 },
    { ngx_string("xattr"),   2 },
...
ngx_command_t ngx_stream_brix_commands[] = {
    ...
    { ngx_string("brix_cache_store"),      /* <store-url> [credential=][block_size=] */
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1234,
      brix_conf_set_store_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.cache_store),
      (void *) offsetof(ngx_stream_brix_srv_conf_t, common.cache_store_args) },

    { ngx_string("brix_stage"),            /* on|off: enable the write-stage tier */
      NGX_STREAM_SRV_CONF | NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.stage_enable),
      NULL },

    { ngx_string("brix_stage_store"),      /* <store-url> [credential=][block_size=] */
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1234,
      brix_conf_set_store_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.stage_store),
      (void *) offsetof(ngx_stream_brix_srv_conf_t, common.stage_store_args) },

    { ngx_string("brix_stage_flush"),      /* sync|async write-back to the backend */
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_enum_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.stage_flush_async),
      brix_stage_flush_enum },

    { ngx_string("brix_cache_max_object"), /* <size>: skip caching larger objects */
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_off_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.cache_max_object),
      NULL },

    { ngx_string("brix_cache_evict_at"),   /* <pct> full -> begin evicting */
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_num_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.cache_evict_at),
      NULL },

    { ngx_string("brix_cache_evict_to"),   /* <pct>: eviction target */
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_num_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.cache_evict_to),
      NULL },

    { ngx_string("brix_cache_index_cache"),/* <n>: per-worker cinfo L1 entries */
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_size_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.cache_index_cache),
      NULL },

    { ngx_string("brix_cache_meta"),       /* auto|local|xattr|sidecar */
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_enum_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.cache_meta_mode),
      brix_cache_meta_enum },

    { ngx_string("brix_cache_slice_size"), /* <size>: per-block slice fill (0=whole) */
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_size_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.cache_slice_size),
      NULL },
    ...
    { ngx_string("brix_idmap_default_user"),            /* MAP: squash account */
      NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_imp_conf_str,
      NGX_STREAM_SRV_CONF_OFFSET,
      BRIX_IMP_F_DEFAULT_USER,
      NULL },

    { ngx_string("brix_idmap_min_uid"),                 /* MAP: reserved floor */
      NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_imp_conf_num,
      NGX_STREAM_SRV_CONF_OFFSET,
      BRIX_IMP_F_MIN_UID,
    ...
    { ngx_string("brix_idmap_cache_ttl"),               /* MAP: cache TTL secs */
      NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_imp_conf_num,
      NGX_STREAM_SRV_CONF_OFFSET,
    ...
    { ngx_string("brix_impersonation_broker_user"),     /* MAP: non-root broker acct */
      ...
      brix_imp_conf_str,
      NGX_STREAM_SRV_CONF_OFFSET,
      BRIX_IMP_F_BROKER_USER,
      NULL },

    { ngx_string("brix_idmap_forbidden_users"),         /* deny-list target accounts */
      NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_imp_conf_str,
      NGX_STREAM_SRV_CONF_OFFSET,
      BRIX_IMP_F_FORBIDDEN_USERS,
      NULL },

    { ngx_string("brix_idmap_forbidden_groups"),        /* deny-list privileged groups */
      NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_imp_conf_str,
      NGX_STREAM_SRV_CONF_OFFSET,
    ...
    { ngx_string("brix_authdb_format"),
      ...
      ngx_conf_set_enum_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, acc_format),
    ...
    { ngx_string("brix_authdb_audit"),
      ...
      ngx_conf_set_enum_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, acc_audit),
    ...
    { ngx_string("brix_authdb_refresh"),
      ...
      ngx_conf_set_num_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, acc_refresh),
      NULL },
    ...
    { ngx_string("brix_acc_gidlifetime"),
      ...
      ngx_conf_set_num_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, acc_gidlifetime),
      NULL },
    ...
    { ngx_string("brix_acc_pgo"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, acc_pgo),
      NULL },
    ...
    { ngx_string("brix_acc_nisdomain"),
      ...
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, acc_nisdomain),
      NULL },
    ...
    { ngx_string("brix_acc_resolve_hosts"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, acc_resolve_hosts),
      NULL },
    ...
    { ngx_string("brix_acc_spacechar"),
      ...
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, acc_spacechar),
      NULL },
    ...
    { ngx_string("brix_acc_encoding"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, acc_encoding),
      NULL },
    ...
    { ngx_string("brix_acc_gidretran"),
      ...
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, acc_gidretran),
      NULL },
    ...
    { ngx_string("brix_throttle_zone"),
      ...
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, throttle_zone_name),
      NULL },
    ...
    { ngx_string("brix_throttle_max_open_files"),
      ...
      ngx_conf_set_num_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, throttle_max_open_files),
      NULL },

    { ngx_string("brix_throttle_max_active_connections"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_num_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, throttle_max_active_conn),
      NULL },
    ...
    { ngx_string("brix_csi"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, csi_enable),
      NULL },
    ...
    { ngx_string("brix_csi_block"),
      ...
      ngx_conf_set_size_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, csi_block),
      NULL },
    ...
    { ngx_string("brix_csi_require"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, csi_require),
      NULL },
    ...
    { ngx_string("brix_csi_trust_fs"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, csi_trust_fs),
      NULL },
    ...
    { ngx_string("brix_krb5_principal"),
      ...
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, krb5_principal),
      NULL },
    ...
    { ngx_string("brix_krb5_keytab"),
      ...
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, krb5_keytab),
      NULL },
    ...
    { ngx_string("brix_krb5_ip_check"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, krb5_ip_check),
      NULL },
    ...
    { ngx_string("brix_metadata_only"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, metadata_only),
      NULL },
    ...
    { ngx_string("brix_supervisor"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, supervisor),
      NULL },
    ...
    { ngx_string("brix_virtual_redirector"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, virtual_redirector),
      NULL },
    ...
    { ngx_string("brix_collapse_redir"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, collapse_redir),
      NULL },

    { ngx_string("brix_collapse_redir_ttl"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, collapse_redir_ttl),
      NULL },
    ...
    { ngx_string("brix_recover_writes"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, recover_writes),
      NULL },
    ...
    { ngx_string("brix_upload_resume"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, upload_resume),
      NULL },
    ...
    { ngx_string("brix_stage_dir"),
      ...
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, upload_stage_dir),
      NULL },

    { ngx_string("brix_registry_slots"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_num_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, registry_slots),
      NULL },
    ...
    /* Phase 22: active health checks (off by default) */    { ngx_string("brix_health_check"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, hc_enabled),
      NULL },
    ...
    { ngx_string("brix_health_check_interval"),
      ...
      ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, hc_interval_ms),
      NULL },
    ...
    { ngx_string("brix_health_check_timeout"),
      ...
      ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, hc_timeout_ms),
      NULL },
    ...
    { ngx_string("brix_health_check_threshold"),
      ...
      ngx_conf_set_num_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, hc_threshold),
      NULL },
    ...
    { ngx_string("brix_health_check_blacklist"),
      ...
      ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, hc_blacklist_ms),
      NULL },
    ...
    { ngx_string("brix_health_check_type"),
      ...
      ngx_conf_set_enum_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, hc_type),
      brix_hc_types },
    ...
    /* ---- legacy FRM directives (brix_frm*) DISABLED 2026-06-30 -------------
     * The Phase-35 FRM durable-tape-staging directive surface (brix_frm,
    ...
    { ngx_string("brix_cache"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cache),
      NULL },
    ...
    { ngx_string("brix_cache_root"),
      ...
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cache_root),
      NULL },

    /* §14 (phase-64): the legacy cache-origin config model is RETIRED. The
     * directives brix_cache_origin{,_tls,_proxy,_cadir,_client,_token_file,
     * _forward_token,_s3_*} are deleted — a cache's source is the export's
     * brix_storage_backend, its identity a named brix_credential attached
     * via brix_storage_credential (x509_proxy/ca_dir, token, s3_access_key/
     * s3_secret_key/s3_region, sss_keytab), and the physical cache is
     * brix_cache_store. cache_origin_family survives below: it is the connect
     * address-family policy for the tier root:// backend, not an origin knob. */

    { ngx_string("brix_cache_origin_family"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_conf_set_cache_origin_family,
      NGX_STREAM_SRV_CONF_OFFSET,
      0,
      NULL },

    { ngx_string("brix_cache_lock_timeout"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_sec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cache_lock_timeout),
      NULL },

    { ngx_string("brix_cache_eviction_threshold"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_conf_set_cache_eviction_threshold,
      NGX_STREAM_SRV_CONF_OFFSET,
      0,
      NULL },
    ...
    { ngx_string("brix_cache_max_file_size"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_conf_set_cache_max_file_size,
      NGX_STREAM_SRV_CONF_OFFSET,
      0,
      NULL },
     ...
     * with brix_wt_{allow,deny}_prefix). */
    { ngx_string("brix_cache_state_root"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cache_state_root),
      NULL },

    { ngx_string("brix_cache_dirty_max_age"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_sec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cache_dirty_max_age),
      NULL },
    ...
    { ngx_string("brix_cache_high_watermark"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_conf_set_cache_watermark,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cache_high_watermark),
      NULL },

    { ngx_string("brix_cache_low_watermark"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_conf_set_cache_watermark,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cache_low_watermark),
      NULL },

    { ngx_string("brix_cache_reap_interval"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_sec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cache_reap_interval),
      NULL },
    ...
    { ngx_string("brix_cache_allow_prefix"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_conf_set_cache_allow_prefix,
      NGX_STREAM_SRV_CONF_OFFSET,
      0,
      NULL },

    /* §14 (phase-64): brix_cache_storage_backend/_block_size are RETIRED —
    ...
    { ngx_string("brix_cache_wt_stage_block_size"),
      ...
      ngx_conf_set_size_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cache_wt_stage_block_size),
      NULL },
     ...
     * root is configured. */
    { ngx_string("brix_wt_stage_high_watermark"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_conf_set_cache_watermark,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cache_wt_stage_high_watermark),
      NULL },

    { ngx_string("brix_wt_stage_low_watermark"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_conf_set_cache_watermark,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cache_wt_stage_low_watermark),
      NULL },
    ...
    { ngx_string("brix_memory_budget"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_off_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, memory_budget),
      NULL },
    ...
    { ngx_string("brix_readv_segment_size"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_size_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, readv_segment_size),
      NULL },
     ...
     * runtime probe fails (brix_uring_validate_conf, §32 fail-fast). */
    { ngx_string("brix_io_uring"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_enum_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, io_uring),
      &brix_io_uring_modes },

    { ngx_string("brix_io_uring_queue_depth"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_num_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, io_uring_queue_depth),
      NULL },

    { ngx_string("brix_io_uring_panic_file"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, io_uring_panic_file),
      NULL },

    { ngx_string("brix_io_uring_admin"),
      NGX_STREAM_SRV_CONF | NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, io_uring_admin),
      NULL },

    { ngx_string("brix_io_uring_restrict"),
      NGX_STREAM_SRV_CONF | NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, io_uring_restrict),
      NULL },

    /* §14 (phase-64): the legacy brix_cache_slice is RETIRED — slice/partial
     * caching is the tier grammar's brix_cache_slice_size (same 1 MiB-multiple
    ...
    { ngx_string("brix_wt_credential"),
      ...
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, wt_credential),
      NULL },
    ...
    { ngx_string("brix_cms_manager"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_conf_set_cms_manager,
      NGX_STREAM_SRV_CONF_OFFSET,
      0,
      NULL },

    { ngx_string("brix_cms_paths"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cms_paths),
      NULL },
    ...
    { ngx_string("brix_cms_interval"),
      ...
      ngx_conf_set_sec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cms_interval),
      NULL },

    { ngx_string("brix_cms_locate_timeout"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cms_locate_timeout),
      NULL },

    /* Phase 50: CMS client (node->manager) resilience deadlines. */
    { ngx_string("brix_cms_read_timeout"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cms_read_timeout),
      NULL },

    { ngx_string("brix_cms_send_timeout"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cms_send_timeout),
      NULL },

    /* Fast cold-start mesh settling (pre-first-login window only). */
    { ngx_string("brix_cms_initial_delay"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cms_initial_delay),
      NULL },

    { ngx_string("brix_cms_connect_retry"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cms_connect_retry),
      NULL },

    { ngx_string("brix_cms_tcp_keepalive"),
      NGX_STREAM_SRV_CONF | NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cms_tcp_keepalive),
      NULL },

    { ngx_string("brix_cms_tcp_user_timeout"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, cms_tcp_user_timeout),
      NULL },

    { ngx_string("brix_listen_port"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_num_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, listen_port),
      NULL },

    { ngx_string("brix_ckscan_depth"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_num_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, ckscan_max_depth),
      NULL },

    { ngx_string("brix_ckscan_max_files"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_num_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, ckscan_max_files),
      NULL },
    ...
    { ngx_string("brix_thread_pool"),
      ...
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.thread_pool_name),
      NULL },

    /* ---- legacy stream proxy directives (brix_proxy*) DISABLED 2026-06-30 ----
     * The legacy stream cache-origin proxy directive surface (brix_proxy,
     ...
     * removal. NOT affected: brix_http_handoff (single-port handoff, retained
     * below) and brix_cache_origin_proxy (phase-64 tier origin). */
    ...
    { ngx_string("brix_http_handoff"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_conf_set_http_handoff,
      NGX_STREAM_SRV_CONF_OFFSET,
      0,
      NULL },
    ...
    { ngx_string("brix_transparent_proxy"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_conf_set_transparent_proxy,
      NGX_STREAM_SRV_CONF_OFFSET,
      0,
      NULL },
    ...
    { ngx_string("brix_guard_stream"),
      NGX_STREAM_SRV_CONF | NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, relay_guard_enable),
      NULL },
    ...
    { ngx_string("brix_tap_proxy"),
      NGX_STREAM_SRV_CONF | NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, proxy_enable),
      NULL },

    { ngx_string("brix_tap_proxy_upstream"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE12,
      brix_conf_set_proxy_upstream,
      NGX_STREAM_SRV_CONF_OFFSET,
      0,
      NULL },

    { ngx_string("brix_tap_proxy_auth"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_conf_set_proxy_auth,
      NGX_STREAM_SRV_CONF_OFFSET,
      0,
      NULL },

    { ngx_string("brix_tap_proxy_login_user"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      brix_conf_set_proxy_login_user,
      NGX_STREAM_SRV_CONF_OFFSET,
      0,
      NULL },
    ...
    { ngx_string("brix_tap_proxy_audit_log"),
      ...
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, proxy_audit_log),
      NULL },

    { ngx_string("brix_tap_proxy_upstream_tls"),
      NGX_STREAM_SRV_CONF | NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, proxy_upstream_tls),
      NULL },
    ...
    { ngx_string("brix_read_timeout"),
      ...
      ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, read_timeout),
      NULL },

    { ngx_string("brix_handshake_timeout"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, handshake_timeout),
      NULL },

    { ngx_string("brix_send_timeout"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, send_timeout),
      NULL },

    { ngx_string("brix_tcp_user_timeout"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, tcp_user_timeout),
      NULL },
    ...
    { ngx_string("brix_tcp_congestion"),
      ...
      ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, tcp_congestion),
      NULL },

    { ngx_string("brix_tcp_keepalive"),
      NGX_STREAM_SRV_CONF | NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, tcp_keepalive),
      NULL },

    { ngx_string("brix_max_connections"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_num_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
    ...
    { ngx_string("brix_manager_stale_after"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
      ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
    ...
    { ngx_string("brix_ocsp_enable"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, ocsp_enable),
      NULL },
    ...
    { ngx_string("brix_ocsp_soft_fail"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, ocsp_soft_fail),
      NULL },
    ...
    { ngx_string("brix_ocsp_stapling"),
      ...
      ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, ocsp_stapling),
      NULL },

    /* Phase 20: shared-memory KV zones, caches, and rate limiting */
    /* brix_kv_zone <name> <size> key=<bytes> val=<bytes>;  (stream main) */
    ...
    { ngx_string("brix_token_cache"),
      ...
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, token_cache_kv),
      NULL },

    /* brix_auth_cache zone=<name> [ttl=<seconds>]; */
    { ngx_string("brix_auth_cache"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE12,
      brix_auth_cache_directive,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, auth_cache),
      NULL },
    ...
    { ngx_string("brix_rate_limit"),
      ...
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, rate_limit),
      NULL },
    ...
    /* SciTags packet marking (src/pmark/) — see phase-34 doc */    { ngx_string("brix_pmark"),
      ...
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.pmark.enable), NULL },
    { ngx_string("brix_pmark_firefly"),
      NGX_STREAM_SRV_CONF | NGX_CONF_FLAG, ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.pmark.firefly), NULL },
    { ngx_string("brix_pmark_flowlabel"),
      NGX_STREAM_SRV_CONF | NGX_CONF_FLAG, ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.pmark.flowlabel), NULL },
    { ngx_string("brix_pmark_scitag_cgi"),
      NGX_STREAM_SRV_CONF | NGX_CONF_FLAG, ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.pmark.scitag_cgi), NULL },
    { ngx_string("brix_pmark_firefly_origin"),
      NGX_STREAM_SRV_CONF | NGX_CONF_FLAG, ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.pmark.firefly_origin), NULL },
    { ngx_string("brix_pmark_http_plain"),
      NGX_STREAM_SRV_CONF | NGX_CONF_FLAG, ngx_conf_set_flag_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.pmark.http_plain), NULL },
    { ngx_string("brix_pmark_echo"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1, ngx_conf_set_msec_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.pmark.echo), NULL },
    { ngx_string("brix_pmark_appname"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1, ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.pmark.appname), NULL },
    { ngx_string("brix_pmark_defsfile"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1, ngx_conf_set_str_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_brix_srv_conf_t, common.pmark.defsfile), NULL },
    { ngx_string("brix_pmark_domain"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1, brix_pmark_set_domain,
      NGX_STREAM_SRV_CONF_OFFSET, 0, NULL },
    { ngx_string("brix_pmark_firefly_dest"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1, brix_pmark_set_firefly_dest,
      NGX_STREAM_SRV_CONF_OFFSET, 0, NULL },
    { ngx_string("brix_pmark_map_experiment"),
      NGX_STREAM_SRV_CONF | NGX_CONF_TAKE23, brix_pmark_set_map_experiment,
      NGX_STREAM_SRV_CONF_OFFSET, 0, NULL },
