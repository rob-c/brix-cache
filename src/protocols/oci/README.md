...
| `oci_delegate.c` | delegated pull (D16): per-credential authorization proof, including cache hits |
| `oci_delegate_identity.c` | downstream Basic identity, transport requirement and uniform refusal |
