 ...
 */
#ifndef XROOTD_SCAN_EMIT_H
#define XROOTD_SCAN_EMIT_H

#include <stdint.h>

typedef void (*xrootd_scan_emit_cb)(void *ctx, uint64_t seq, void *payload);
...
void xrootd_scan_emitq_init(xrootd_scan_emitq_t *q, void **slots,
...
int xrootd_scan_emitq_submit(xrootd_scan_emitq_t *q, uint64_t seq, void *payload,
                             xrootd_scan_emit_cb cb, void *ctx);

#endif /* XROOTD_SCAN_EMIT_H */
