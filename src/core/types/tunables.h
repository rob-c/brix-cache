 ...
 * BRIX_READ_REQUEST_MAX, but the response is split into larger 16 MiB
 ...
 * BRIX_READ_REQUEST_MAX/BRIX_READ_CHUNK_MAX chunks (= 4 → 32 bytes).  Sizing
