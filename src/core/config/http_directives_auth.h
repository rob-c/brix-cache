...
#pragma once
    ...
    { ngx_string("brix_crl_mode"),
      ...
      &brix_http_crl_modes },
    /* 2.0 F19 (xrd.tlsca residuals): CRL reach + verification-log level, the
     * same grammar and the same defaults as on the stream plane. */
    { ngx_string("brix_crl_scope"),
      BRIX_HTTP_ALL_CONF | NGX_CONF_TAKE1, ngx_conf_set_enum_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_brix_common_conf_t, common.crl_scope),
      &brix_http_crl_scopes },
    { ngx_string("brix_tls_verify_log"),
      BRIX_HTTP_ALL_CONF | NGX_CONF_TAKE1, ngx_conf_set_enum_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_brix_common_conf_t, common.tls_verify_log),
      &brix_http_tls_verify_logs },
    ...
    { ngx_string("brix_tpc_source_allow"),
      ...
      NGX_HTTP_LOC_CONF_OFFSET,
      0, NULL },
    /* TPC identity matrix (2.0 F18) — the inner, identity-plane gate; the host
     * plane above stays the outer one and these can only narrow it. */
    { ngx_string("brix_tpc_allow_identity"),
      BRIX_HTTP_ALL_CONF | NGX_CONF_2MORE, brix_tpc_conf_allow_identity,
      NGX_HTTP_LOC_CONF_OFFSET,
      0, NULL },
    { ngx_string("brix_tpc_require"),
      BRIX_HTTP_ALL_CONF | NGX_CONF_TAKE2, brix_tpc_conf_require,
      NGX_HTTP_LOC_CONF_OFFSET,
      0, NULL },
    { ngx_string("brix_tpc_restrict"),
      BRIX_HTTP_ALL_CONF | NGX_CONF_1MORE, brix_tpc_conf_restrict,
      NGX_HTTP_LOC_CONF_OFFSET,
      0, NULL },
    { ngx_string("brix_tpc_oids"),
      BRIX_HTTP_ALL_CONF | NGX_CONF_FLAG, ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_brix_common_conf_t, common.tpc_oids), NULL },
    ...
    { ngx_string("brix_token_jwks_refresh_interval"),
      ...
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_brix_common_conf_t,
               common.token_jwks_refresh_interval), NULL },
