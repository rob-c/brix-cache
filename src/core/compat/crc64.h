#ifndef XROOTD_COMPAT_CRC64_H
#define XROOTD_COMPAT_CRC64_H
 ...
 *         XROOTD_CRC64_XZ   = CRC-64/XZ   (a.k.a. GO-ECMA; the common library
 ...
 *         XROOTD_CRC64_NVME = CRC-64/NVME (a.k.a. Rocksoft; AWS S3
...
typedef enum {
    XROOTD_CRC64_XZ   = 0,   /* CRC-64/XZ   — generic "crc64"/"crc64xz" */
    XROOTD_CRC64_NVME = 1    /* CRC-64/NVME — S3 "crc64nvme" */
} xrootd_crc64_variant_t;

/*
 * xrootd_crc64_extend - rolling CRC64 update for the given variant.
 *
 ...
 */
uint64_t xrootd_crc64_extend(xrootd_crc64_variant_t variant, uint64_t crc,
    const void *buf, size_t len);

/*
 * xrootd_crc64_value - one-shot CRC64 of buf[0..len) for the given variant.
 * Equivalent to xrootd_crc64_extend(variant, 0, buf, len).
 */
uint64_t xrootd_crc64_value(xrootd_crc64_variant_t variant, const void *buf,
    size_t len);

/*
 * xrootd_crc64_combine - combine two CRC64 values without re-reading data.
 *
 ...
 */
uint64_t xrootd_crc64_combine(xrootd_crc64_variant_t variant, uint64_t crc1,
    uint64_t crc2, uint64_t len2);

#endif /* XROOTD_COMPAT_CRC64_H */
