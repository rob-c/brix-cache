...
#ifndef XROOTD_COMPAT_RANGE_H
#define XROOTD_COMPAT_RANGE_H
...
/*
 * WHAT: Parse an RFC 7233 "bytes=" Range header value into xrootd_http_range_t.
 *
 ...
 *       "bytes=". Delegate actual parsing to xrootd_http_parse_range_vector() in range_vector.c
