 ...
 * WHY:  the module decodes this prefix (brix_handle_setattr) and the native
 ...
 */
#ifndef BRIX_COMPAT_VENDOR_EXT_H
#define BRIX_COMPAT_VENDOR_EXT_H

#include <stdint.h>

/* Wire fact: the kXR_setattr attribute prefix is 44 bytes (see wire_vendor_ext.h
 * BRIX_SETATTR_PREFIX_LEN). Kept locally so the codec's offsets are self-contained. */
...
#endif /* BRIX_COMPAT_VENDOR_EXT_H */
