...
#ifndef XROOTD_COMPAT_COPY_RANGE_H
#define XROOTD_COMPAT_COPY_RANGE_H

#include <ngx_core.h>
#include <sys/types.h>

/*
 * xrootd_copy_range — copy len bytes from src_fd at src_off to dst_fd at
 ...
 */
ngx_int_t xrootd_copy_range(ngx_log_t *log,
                             int src_fd, off_t src_off,
                             int dst_fd, off_t dst_off,
                             size_t len,
                             const char *src_path, const char *dst_path);

#endif /* XROOTD_COMPAT_COPY_RANGE_H */
