...
#ifndef XROOTD_RANGE_VECTOR_H
#define XROOTD_RANGE_VECTOR_H

#include <ngx_http.h>

/*
 * xrootd_byte_range_t — a normalised, inclusive byte interval.
 *
...
/*
 * xrootd_range_vector_opts_t — caller-supplied policy for the parser.
 *
 ...
 * opts:      parsing policy (see xrootd_range_vector_opts_t above).
...
/*
 * xrootd_range_vector_validate_total — sum total response bytes, check cap.
 *
...
/*
 * xrootd_range_vector_next_coalesced_run — find a run of contiguous ranges.
 *
