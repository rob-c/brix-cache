 ...
 *
 * WHAT: Implements xrootd_tpc_progress_emit(), the single entry point both
 ...
 *      id/bytes_done/state to xrootd_tpc_registry_update().
 */
 ...
 * underlying xrootd_tpc_registry_update() result.
 */
ngx_int_t
