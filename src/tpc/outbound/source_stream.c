 ...
 * concern separate from the open/resolve (source_open.c), the driver
 * (source.c), and the size/checksum concern (source_verify.c, split out when
 * this file crossed the 600-line cap). HOW: send read → drain → advance offset
 * → repeat to EOF → sync.
