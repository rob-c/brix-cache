...
/* ckt_is_root_url — detect XRootD URLs.
 *
 ...
 *       will match. */
int
ckt_is_root_url(const char *s)
{
    return strstr(s, "://") != NULL;
}

/* ckt_path_join — safely concatenate a directory and filename.
 *
...
int
ckt_path_join(const char *dir, const char *name, char *out, size_t outsz)
{
            ...
            cktree_file_fn cb, void *u, int *errors)
{
    ...
    while ((de = readdir(d)) != NULL) {
        ...
        if (ckt_path_join(lpath, de->d_name, lc, sizeof(lc)) != 0
