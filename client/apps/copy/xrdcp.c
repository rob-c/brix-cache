...
usage_fp(FILE *out, const char *prog)
{
    fprintf(out,
        ...
        "  --sss-vorg <v> --sss-role <r>  sss: assert a VO and a role\n"
        "  --sss-endorse <s>  sss: opaque endorsements blob\n"
        "  --sss-creds-file <p>  sss: forward the credential in <p> (the server\n"
        "                 keeps it only under brix_sss_getcreds on)\n"
        "  --sss-sndlid   sss: let the server name the login id (2-round form)\n"
