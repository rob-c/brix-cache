...
import base64
import glob
import klib  # remote: audit log lives on the SERVER
import hashlib
import os
import time
import uuid
...
def _find_audit_line(token, kind="stage", timeout=5.0):
    ...
    # remote: the audit log is written by the SERVER under /var/log/brix
    audit = ["/usr/local/nginx/logs/xfer_audit.log",
