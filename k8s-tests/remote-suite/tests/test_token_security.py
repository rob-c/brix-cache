...
class TestScopePathBoundary:
    ...
    def test_scope_data_write_matches_data_slash_file(self, issuer):
        ...
        klib.svc_mkdir(SERVER_SVC, os.path.join(SERVER_DATA, "data"))
    ...
    def test_scope_data_read_via_xrd(self, issuer):
        ...
        klib.svc_mkdir(SERVER_SVC, os.path.join(SERVER_DATA, "data"))
        klib.svc_write(SERVER_SVC, os.path.join(SERVER_DATA, "data", "xrd_test.txt"), "hello")
    ...
    def test_scope_subdir_does_not_match_sibling_write(self, issuer):
        ...
        klib.svc_mkdir(SERVER_SVC, os.path.join(SERVER_DATA, "b"))
    ...
    def test_scope_exact_path_write_allowed_inside(self, issuer):
        klib.svc_mkdir(SERVER_SVC, os.path.join(SERVER_DATA, "exact"))
    ...
    def test_scope_deep_path_write_allowed(self, issuer):
        klib.svc_mkdir(SERVER_SVC, os.path.join(SERVER_DATA, "a", "b", "c"))
    ...
    def test_scope_deep_path_no_match_prefix_only_write(self, issuer):
        ...
        klib.svc_mkdir(SERVER_SVC, os.path.join(SERVER_DATA, "a"))
    ...
    def test_write_scope_blocks_read(self, issuer):
        ...
        klib.svc_write(SERVER_SVC, os.path.join(SERVER_DATA, "write_only_noread.txt"), b"secret")
    ...
    def _seed_vo_dirs(self):
        for vo in ("cms", "atlas"):
            d = os.path.join(SERVER_DATA, vo)
            klib.svc_mkdir(SERVER_SVC, d)
            klib.svc_write(SERVER_SVC, os.path.join(d, "r.txt"), vo.encode())
