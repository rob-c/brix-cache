...
SERVER_SVC = "mega"
import klib  # remote: seed the data file on the SERVER
DATA_SIZE = 4096
...
def data_file():
    ...
    klib.svc_write(SERVER_SVC, "/data/xrootd/" + DATA_NAME.lstrip("/"), PATTERN)
    yield DATA_NAME
    klib.svc_rm(SERVER_SVC, "/data/xrootd/" + DATA_NAME.lstrip("/"))
