...
class TestGSICertAuth:
    ...
    @pytest.mark.skip(reason='needs a stock-XrdHttp reference server on XRDHTTP_HTTPS_PORT for the both-succeed comparison; not deployed in the single-mega remote setup (the 5 non-reference GSI/token checks pass)')
