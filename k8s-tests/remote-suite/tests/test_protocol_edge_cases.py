...
class TestHandleStat:
    ...
    def _setup(self):
        ...
        klib.svc_write(SERVER_SVC, self.disk, b"handle stat test content\n")
        yield
        klib.svc_rm(SERVER_SVC, self.disk)
...
class TestReadvEdgeCases:
    ...
    def _setup(self):
        ...
        klib.svc_write(SERVER_SVC, self.disk, b"A" * 1000)
        yield
        klib.svc_rm(SERVER_SVC, self.disk)
...
class TestOpenWithRetstat:
    ...
    def _setup(self):
        ...
        klib.svc_write(SERVER_SVC, self.disk, b"X" * 256)
        yield
        klib.svc_rm(SERVER_SVC, self.disk)
