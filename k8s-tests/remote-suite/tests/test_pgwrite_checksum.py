...
_DATA_DIR  = "/data/xrootd"
SERVER_SVC = "mega"
import klib  # remote: setup/verify on the SERVER
...
class TestPgWriteChecksumVerification:
    ...
    def test_good_write_data_reaches_disk(self):
        ...
        assert klib.svc_exists(SERVER_SVC, disk_path), "written file not found on disk"
        assert klib.svc_read(SERVER_SVC, disk_path) == data, "data on disk does not match written payload"
        klib.svc_rm(SERVER_SVC, disk_path)
    ...
    def test_bad_write_gates_close(self):
        ...
        try:
            ...
            sock.close()
        if klib.svc_exists(SERVER_SVC, disk_path):
            klib.svc_rm(SERVER_SVC, disk_path)
    ...
    def test_overwrite_partial_existing_content(self):
        ...
        klib.svc_write(SERVER_SVC, disk_path, original)
        ...
        on_disk = klib.svc_read(SERVER_SVC, disk_path)
