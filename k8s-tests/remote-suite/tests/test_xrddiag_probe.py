...
def anon_server(tmp_path_factory):
    _guard_anon_server_1()
    proc = subprocess.run(["make", "-C", CLIENT_DIR, "xrddiag"],
                          capture_output=True, text=True, timeout=180)
    _guard_anon_server_2(proc)
    _guard_anon_server_3()
