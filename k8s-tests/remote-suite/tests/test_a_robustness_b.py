...
class TestStateMachineAttacks:
    ...
    def test_read_from_closed_handle(self):
        ...
        """
        test_path = os.path.join(SERVER_DATA, "robustness_reuse.bin")
        klib.svc_write(SERVER_SVC, test_path, b"REUSE TEST DATA " * 64)   # 1024 bytes
    ...
    def test_endsess_closes_open_file_handles(self):
        ...
        """
        test_path = os.path.join(SERVER_DATA, "robustness_endsess.bin")
        klib.svc_write(SERVER_SVC, test_path, b'ENDSESS DATA ' * 80)
...
class TestConcurrencySafety:
    ...
    def test_concurrent_stat_and_ping(self):
        ...
        """
        test_path = os.path.join(SERVER_DATA, "robustness_concurrent.bin")
        klib.svc_write(SERVER_SVC, test_path, b'z' * 512)
