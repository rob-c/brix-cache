...
_IMAGES = [
    (("dev",),                         "brix-smoke",       None),
    (("gsi", "token", "fleet", "full", "s3gsi", "s3voms", "pbgsi"), "brix-authority",   "authority"),
    (("token", "full"),                "brix-krb5-kdc",    "krb5-kdc"),
    (("chaos", "cms", "fleet", "full", "s3fwd", "s3gsi", "s3voms", "pbgsi"), "brix-server",      "server"),
    (("fleet", "full", "s3fwd"),       "brix-test-runner", "test-runner"),
    (("s3gsi", "s3voms", "pbgsi"),     "brix-client",      "client"),
]
