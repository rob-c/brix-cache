...
def test_pgread_single_page_off0(srv, name):
    ...
    def _assert_test_pgread_single_page_off0_1():
    ...
    _assert_test_pgread_single_page_off0_1()
    off, page, crc = pg_o[0]
    def _assert_test_pgread_single_page_off0_2():
        assert off == 0, f"OUR pgread page offset {off} != 0"
        assert crc == crc32c(page), f"OUR pgread {name} per-page CRC32c wrong"

    _assert_test_pgread_single_page_off0_2()
