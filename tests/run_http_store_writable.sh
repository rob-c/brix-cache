...
http { client_body_temp_path $PFX/a/tmp; server { listen 127.0.0.1:${APORT};
  location / { dav_methods PUT DELETE; xrootd_webdav on; xrootd_webdav_root $PFX/a/root; xrootd_webdav_auth none; xrootd_webdav_allow_write on; } } }
E2
...
http { client_body_temp_path $PFX/b/tmp; server { listen 127.0.0.1:${BPORT};
  location / { dav_methods PUT DELETE;
    ...
    xrootd_webdav_stage on; xrootd_webdav_stage_store http://127.0.0.1:${APORT}; xrootd_webdav_stage_flush sync; } } }
E2
