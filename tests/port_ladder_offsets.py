# port_ladder_offsets.py — the category OFFSET/WIDTH ladder + its evolution
# history, split off from port_ladder.py for the 600 logical-line cap.
...
# 2026-09-01/02 (phase-107): 933 -> 967, +34 — C1 spill 6, C5 reserve 5, C4
# bulk-delete 12, C2 prepare-recall/evict 3, C7 locks 8 (lc-p107-* groups;
