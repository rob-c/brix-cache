...
def _guard_test_credential_webdav_xroot_flow_1():
    if not os.access(NGINX_BIN, os.X_OK):
        pytest.skip(f"nginx binary not executable: {NGINX_BIN}")

def _guard_test_credential_webdav_xroot_flow_2():
    if not MAKE_TOKEN.exists():
        pytest.skip(f"token helper not found: {MAKE_TOKEN}")

def _guard_test_credential_webdav_xroot_flow_3(results):
...
def test_credential_webdav_xroot_flow(tmp_path):
    _guard_test_credential_webdav_xroot_flow_1()
    _guard_test_credential_webdav_xroot_flow_2()

    results = run_checks(tmp_path, nginx_bin=NGINX_BIN)
    _guard_test_credential_webdav_xroot_flow_3(results)
    ...
    def _assert_test_credential_webdav_xroot_flow_1():
    ...
    _assert_test_credential_webdav_xroot_flow_1()
