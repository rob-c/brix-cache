"""GSI client environment for the globus-url-copy tests.

Moved verbatim from ``tests/gridftp_client_env.py``; pure stdlib, no settings
and no fleet state, so the move is a relocation and nothing else.
"""
