"""ARCHIVE — the pre-TS-4 flat ``fleet_declares.py`` implementation.

The archived and canonical definitions intentionally evolve together when a
repository-wide source invariant requires a structural refactor. The TS-4
move guard still compares every definition byte-for-byte.
"""
