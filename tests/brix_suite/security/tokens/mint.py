"""Claim/header basics and alternate key material for the token forge.

Moved verbatim out of `tests/_tokenforge_part2_mixina.py` by TS-5.  Bodies are
unchanged; only the class name and the import prelude differ, and the prelude
now names `jose` as the single home of `_b64url`/`_seg` instead of re-defining
them here.
"""
import base64
import hashlib
