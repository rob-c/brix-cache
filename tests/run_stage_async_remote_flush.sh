...
http { client_body_temp_path $PFX/b/tmp; server { listen 127.0.0.1:${BPORT};
  location / { dav_methods PUT DELETE;
    brix_webdav on; brix_webdav_root $PFX/b/export; brix_webdav_auth none; brix_webdav_allow_write on;
    brix_webdav_storage_backend root://127.0.0.1:${OPORT};
    brix_webdav_stage on; brix_webdav_stage_store posix:$PFX/b/stage; brix_webdav_stage_flush async; } } }
E2
