...
def test_query_xml_and_base64url_helpers_are_shared():
    ...
    _assert_markers("src/protocols/webdav/propfind_internal.h", ["../compat/http_xml.h"])
...
def test_iso8601_and_hex_helpers_are_shared():
    ...
    _assert_markers("src/protocols/webdav/propfind_internal.h", ["../compat/time.h"])
...
def test_token_fs_usage_and_shm_slot_helpers_are_shared():
    ...
    _assert_absent("src/protocols/webdav/lock.c", ["../compat/shm_slots.h", "xrootd_shm_"])
...
def test_http_header_body_and_condition_helpers_are_shared():
    ...
    _assert_markers("src/protocols/s3/s3_put_internal.h", ["../compat/http_body.h"])
    ...
    _assert_markers("src/protocols/webdav/propfind_internal.h", ["../compat/http_body.h"])
...
def test_checksum_fs_walk_staging_and_cms_frame_helpers_are_shared():
    ...
    _assert_markers("src/protocols/s3/s3_put_internal.h", ["../compat/staged_file.h"])
