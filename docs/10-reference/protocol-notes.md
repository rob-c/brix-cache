...
> ⚠️ **Reference tier — advanced.** Non-obvious wire protocol behavior discovered by reverse-engineering the XRootD C++ source. None of this is in the official specification.
>
