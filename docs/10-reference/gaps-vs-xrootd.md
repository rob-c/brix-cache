...
Optional features present in the official `xrootd` daemon that are NOT implemented in nginx-xrootd. Organized
...
module. For hard blockers, see [status.md](../05-operations/operation-status.md).
...
Prometheus metrics, CMS/manager integration, and basic caching. See [status.md](../05-operations/operation-status.md)
...
only. Tape staging is explicitly out of scope (see [status.md](../05-operations/operation-status.md)). |
...
| **nginx-xrootd equivalent** | ❌ No. The module serves local POSIX storage
only. PSS is explicitly out of scope (see [status.md](../05-operations/operation-status.md)). |
...
| **nginx-xrootd equivalent** | ❌ No. The module serves local POSIX storage
only. Ceph is explicitly out of scope (see [status.md](../05-operations/operation-status.md)). |
...
archive storage. |
| **nginx-xrootd equivalent** | ❌ No. The module serves local POSIX storage
only. Archive transfer is explicitly out of scope (see [status.md](../05-operations/operation-status.md)). |
...
| **nginx-xrootd equivalent** | ❌ No. The module serves local POSIX storage
only. Mass storage integration is explicitly out of scope (see [status.md](../05-operations/operation-status.md)). |
...
- [status.md](../05-operations/operation-status.md) — Full implementation status with opcode coverage, authentication, TLS, query subtypes, monitoring, CMS/manager integration, WebDAV, S3, and known gaps
- [comparison-with-xrootd.md](design-rationale.md) — Deployment-type analysis and design rationale
- [cluster-mode.md](../05-operations/cluster-management.md) — Manager mode configuration and architecture
- [webdav.md](../04-protocols/webdav-overview.md) — WebDAV configuration and features
- [metrics-and-logging.md](../08-metrics-monitoring/monitoring-guide.md) — Prometheus metrics and access logging
