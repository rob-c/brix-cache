...
[docs/09-developer-guide/release-process.md](../09-developer-guide/release-process.md).
...
audited in the [2.0 readiness register](release-2.0-readiness.md);
every registered directive now has user-facing prose in
[`docs/03-configuration/directives.md`](../03-configuration/directives.md),
...
- **`brix_pss_dca` has been removed.** The directive was registered in
  ...
  [2.0 readiness register](release-2.0-readiness.md).
...
- **Observability compatibility aliases have been removed.** Update nginx
  ...
  [Phase 112](../refactor/phase-112-observability-compatibility-removal.md).
...
- **Serve-while-filling for the whole-file cache** (phase-115 W4.1).
  ...
  See [Phase 115](../refactor/phase-115-deployment-surface-and-remaining-feature-bodies.md) W4.1.
- **In-memory cache store** (phase-115 W4.2). `brix_cache_store ram:<size>`
  ...
  See [Phase 115](../refactor/phase-115-deployment-surface-and-remaining-feature-bodies.md) W4.2.
- **Per-page verification of origin reads** (phase-115 W4.3). The store-line
  ...
  See [Phase 115](../refactor/phase-115-deployment-surface-and-remaining-feature-bodies.md) W4.3.
- **Tape dataset archiver** (phase-115 W3.1). `tape://<adapter>/<base>?arc=<depth>`
  ...
  See [Phase 115](../refactor/phase-115-deployment-surface-and-remaining-feature-bodies.md) W3.1.
- **Tape-buffer purge engine** (phase-115 W3.2). The online buffer behind a
  ...
  See [Phase 115](../refactor/phase-115-deployment-surface-and-remaining-feature-bodies.md) W3.2.
- **Space groups** (phase-115 W3.3). `brix_oss_space <group> <prefix>
  ...
  See [Phase 115](../refactor/phase-115-deployment-surface-and-remaining-feature-bodies.md) W3.3.
- **GridFTP extended block mode and a protected data channel** (phase-115 W5.1).
  ...
  See [Phase 115](../refactor/phase-115-deployment-surface-and-remaining-feature-bodies.md) W5.1.
- **Bounded GridFTP retrieves (`ERET`)** (phase-115 W5.2). A ranged read of a
  ...
  See [Phase 115](../refactor/phase-115-deployment-surface-and-remaining-feature-bodies.md) W5.2.
- **Striped GridFTP reads (`SPAS`)** (phase-115 W5.3). A new store-line
  ...
  **Every stripe address must be the control channel's own pinned peer.** A
  ...
  See [Phase 115](../refactor/phase-115-deployment-surface-and-remaining-feature-bodies.md) W5.3.
- **Same-origin `COPY` on GridFTP-backed exports** (phase-115 W5.4). A WebDAV
  ...
  **GridFTP-over-SSH (`sshftp://`) remains unimplemented and the scheme is not
  ...
  origin.
  See [Phase 115](../refactor/phase-115-deployment-surface-and-remaining-feature-bodies.md) W5.4.
- **A lab lane that points brix at a real GridFTP door** (phase-115 W5.5). The
  ...
  See [Phase 115](../refactor/phase-115-deployment-surface-and-remaining-feature-bodies.md) W5.5.
...
- **Every exported metric family is now documented.** Twenty-three families were
  ...
  [Metrics Overview](../08-metrics-monitoring/metrics-overview.md) gains a
...
- **The WebDAV perimeter reverse proxy is documented as removed.** The
  ...
  [operation-status.md](../05-operations/operation-status.md) and
  [forward-vs-reverse-proxy.md](../02-concepts/forward-vs-reverse-proxy.md)
...
- **A fabricated test citation was removed from the client resilience
  claims.** [native-client-tools.md](../04-protocols/native-client-tools.md)
...
- **The fuzzing framework is no longer listed as outstanding work.**
  [hardening-strategy.md](../07-security/hardening-strategy.md) carried it as
...
- **`tools/diag/lock_scan.py` ships in the package again.** The
  [directives reference](../03-configuration/directives.md) tells an operator
