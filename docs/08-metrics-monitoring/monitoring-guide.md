...
Every request leaves a trace. This section covers every Prometheus metric BriX-Cache exports, how to set up scraping, how to use the HTTPS monitoring dashboard, how to read the access logs, and what healthy numbers look like at scale.
