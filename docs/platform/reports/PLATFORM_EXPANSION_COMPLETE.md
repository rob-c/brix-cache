...
| `docs/platform/pal/ARCHITECTURE.md` | Created | PAL architecture specification |
...
- [PLATFORM_EXPANSION_PLAN.md](../PLATFORM_EXPANSION_PLAN.md) - Master roadmap
- [windows-build.md](../windows-build.md) - Windows build guide
- [arm64-linux-build.md](../arm64-linux-build.md) - ARM64 Linux guide
- [arm64-macos-build.md](../arm64-macos-build.md) - Apple Silicon guide
- [PLATFORM_SUPPORT_MATRIX.md](../PLATFORM_SUPPORT_MATRIX.md) - Platform matrix

### Implementation

- [src/platform/windows/](../../../src/platform/windows/) - Windows PAL skeleton
- [docs/platform/pal/ARCHITECTURE.md](../pal/ARCHITECTURE.md) - PAL architecture
