...
| `docs/platform/pal/windows/HANDLE_ABSTRACTION_DESIGN.md` | 500+ | Design documentation |
...
<a id="design-document-handle_abstraction_designmd"></a>

### Design Document (`docs/platform/pal/windows/HANDLE_ABSTRACTION_DESIGN.md`)
...
<a id="implementation-report-handle_abstraction_reportmd"></a>

### Implementation Report (`docs/platform/pal/windows/HANDLE_ABSTRACTION_REPORT.md`)
