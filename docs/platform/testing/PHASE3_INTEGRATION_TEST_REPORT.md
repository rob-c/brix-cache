...
```bash
$ python3 run_phase3_tests.py --coverage --html
...
```bash
$ python3 run_phase3_tests.py --platform windows --performance
...
stage('Phase 3 Integration Tests') {
    steps {
        sh 'cd tests/platform && python3 run_phase3_tests.py --junit --coverage'
    }
    post {
        always {
...
| `run_phase3_tests.py` | Test runner script | 350+ |
