...
This document traces a single XRootD request from the moment a TCP connection
arrives to the moment the response byte leaves the socket. Read it alongside
the source code; file names link to the corresponding directories.
