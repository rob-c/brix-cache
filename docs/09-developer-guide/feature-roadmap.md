...
> **Status (2026-09-09 — 2.0).** Written in 2026-05/06; every ✓ IMPLEMENTED heading below
> still holds, and the open items are re-dispositioned (ship / not-in-2.0 /
> deferred-by-design) in the 2.0 register. For what 2.0 ships, what it deliberately does
> not, and what is still open, use the 2.0 register,
