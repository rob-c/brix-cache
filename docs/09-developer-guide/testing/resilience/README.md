...
The files described here remain in [`tests/resilience/`](../../../../tests/resilience/).
...
| `docs/09-developer-guide/testing/resilience/results-packet-loss-mount-2026-06-23.md` | Recorded sweep results: xrootdfs mount read/write under 0–20% loss + 0–3% reorder, with interpretation. |
| `docs/09-developer-guide/testing/resilience/results-xrdcp-loss-comparison-2026-06-23.md` | Recorded comparison: repo `xrdcp`+nginx vs official `xrdcp`+xrootd under 0–1% loss. |
...
- The runner-selected nginx (`TEST_NGINX_BIN`) and its configured modules.
  The standalone prerequisite override remains `RESIL_NGINX_BIN`.
