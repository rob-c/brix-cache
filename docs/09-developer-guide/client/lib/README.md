...
The files described here remain in [`client/lib/`](../../../../client/lib/).
...
[docs/refactor/phase-69-client-map.tsv](../../../refactor/phase-69-client-map.tsv).
...
[docs/refactor/phase-38-file-size-unix-modularity.md](../../../refactor/phase-38-file-size-unix-modularity.md)).
