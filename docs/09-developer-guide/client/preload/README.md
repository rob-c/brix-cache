...
The files described here remain in [`client/preload/`](../../../../client/preload/).
...
- `docs/09-developer-guide/client/lib/README.md` — the `libbrix` library the shim opens its sessions through.
- `docs/09-developer-guide/client/README.md` (client tree) and the FUSE driver (`xrootdfs`) for the
