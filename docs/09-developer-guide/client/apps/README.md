...
The files described here remain in [`client/apps/`](../../../../client/apps/).
...
| `libbrixposix_preload.so` | LD_PRELOAD POSIX→XRootD read-path shim (see [`../preload/`](../../../../client/preload/)). |
...
Per [`docs/superpowers/specs/2026-07-06-client-cli-usability-design.md`](../../../superpowers/specs/2026-07-06-client-cli-usability-design.md) §2:
