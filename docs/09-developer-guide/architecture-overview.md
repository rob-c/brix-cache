...
- **[Architecture Overview (Visual)](../11-architecture/overview.md)** — High-level diagram, deployment modes, request flows, and file reference index
...
- [Native XRootD stream layer](../11-architecture/stream.md)
- [WebDAV request lifecycle](../11-architecture/webdav.md)
- [S3 request lifecycle](../11-architecture/s3.md)
