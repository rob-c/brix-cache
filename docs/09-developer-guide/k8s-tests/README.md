...
The files described here remain in [`k8s-tests/`](../../../k8s-tests/).
...
`docs/09-developer-guide/k8s-tests/FULL_K8S_TEST_SUITE.md`.
...
minikube, kubectl, docker, jq). See `docs/09-developer-guide/k8s-tests/guides/walkthrough.md` for exact commands.
