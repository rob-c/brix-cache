...
The files described here remain in [`k8s-tests/remote-suite/utils/`](../../../../../k8s-tests/remote-suite/utils/).
...
See [docs/test-pki.md](../../../../06-authentication/test-pki-setup.md) for the full PKI setup walkthrough.
...
See [docs/test-tokens.md](../../../../06-authentication/test-token-generation.md) for the full token setup walkthrough.
...
Each line shows direction (`C>S` = client-to-server, `S>C` = server-to-client), byte count, and raw hex. Cross-reference with [docs/protocol-notes.md](../../../../10-reference/protocol-notes.md) to decode the fields.
