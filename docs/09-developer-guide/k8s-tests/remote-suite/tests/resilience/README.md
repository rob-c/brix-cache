...
The files described here remain in [`k8s-tests/remote-suite/tests/resilience/`](../../../../../../k8s-tests/remote-suite/tests/resilience/).
...
| `docs/09-developer-guide/k8s-tests/remote-suite/tests/resilience/results-packet-loss-mount-2026-06-23.md` | Recorded sweep results: xrootdfs mount read/write under 0–20% loss + 0–3% reorder, with interpretation. |
| `docs/09-developer-guide/k8s-tests/remote-suite/tests/resilience/results-xrdcp-loss-comparison-2026-06-23.md` | Recorded comparison: repo `xrdcp`+nginx vs official `xrdcp`+xrootd under 0–1% loss. |
