...
The files described here remain in [`k8s-tests/remote-suite/tests/valgrind/`](../../../../../../k8s-tests/remote-suite/tests/valgrind/).
...
`src/observability/dashboard/http_tracking.c` and a JWKS `EVP_PKEY` reload leak in
