...
The implementation and executable examples remain in the standalone
[BriXTest sub-project](../../../brixtest/); this guide collection lives under
`docs/09-developer-guide/brixtest/`. Commands retain the working directories
stated in each guide. The repository-specific nginx-xrootd adapter is not
part of the BriXTest distribution.
