...
This is a correctness requirement as much as an aesthetic one. Most bugs in C come from misreading ownership, lengths, or which buffer a pointer belongs to. The rules below exist to make that class of bug easy to spot in review.
