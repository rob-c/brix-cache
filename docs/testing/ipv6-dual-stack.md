# Testing Dual-Stack IPv4+IPv6 Support in nginx-xrootd

## 1. Scope and Motivation

This document describes what is needed to test the existing codebase for dual-stack
IPv4+IPv6 support, identifies where the code currently fails, and surfaces ambiguities
in protocol specifications, RFCs, and the reference XRootD implementation.
