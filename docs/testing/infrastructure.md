...
conftest.pytest_sessionstart()
        ...
        │       │   (starts all standard listeners: 11094-11097, 8443, 9100, ...)
        │       │
...
The script manages a main nginx instance (port 11094-11097, 8443, etc.) and reference xrootd servers (if installed). Logs are written to `/tmp/xrd-test/logs/`.
...
For full token documentation, see [test-tokens.md](test-tokens.md).
...
| 8443 | `davs://` | GSI + Token | WebDAV over HTTPS |
