...
This document records the code-level optimizations in the module: what was
changed, what cost it removes, why that matters, and which workloads should
...
- [WebDAV](webdav.md) — items 18–24: root pre-resolve, fd cache, GET/PUT paths, x509 auth cache
- [Auth and cross-cutting](auth.md) — items 25–28: GSI HMAC reuse, token-local auth, handle reuse, atomic metrics
