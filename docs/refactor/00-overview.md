...
| 43 | [`phase-43-s3-protocol-completion.md`](phase-43-s3-protocol-completion.md) | S3 protocol completion (plan) — `src/protocols/s3/` correctness + SDK compatibility (aws-cli/boto3/rclone/s5cmd); builds on phase-9 SigV4 + existing multipart/POST-object/DeleteObjects + crc64 reuse. No root:///WebDAV changes |
