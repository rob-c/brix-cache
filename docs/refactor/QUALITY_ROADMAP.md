...
**Current reconciliation (2026-09-02):** HISTORICAL ROADMAP. Most structural
gates described here landed, but the current tree is not at the former zero-debt
close. Phase 111 records the exact native/Python size, Python CCN,
Cognitive/NPath and pytest-collection failures. The still-open coverage-floor
graduation remains owned by `coverage-fast-tier-plan.md`.
