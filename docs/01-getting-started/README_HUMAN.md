...
front page; [docs/index.md](../index.md) is the full guided map.)
...
[beginner path](../index.md#-i-want-a-working-server---start-here) — no
...
[XRootD Basics](../02-concepts/xrootd-basics.md) and the
...
[Design Rationale](../10-reference/design-rationale.md).
...
[Operation Status](../05-operations/operation-status.md).
...
**Three deployment shapes** (details: [Deployment Modes](../02-concepts/deployment-modes.md)):
...
[Cross-Protocol Unification](../11-architecture/cross-protocol-unification.md)
...
[threat model](../07-security/threat-model.md), a
[four-layer hardening guide](../07-security/hardening-guide.md), fuzz
...
and the embeddable `libbrix` C library. Tour:
...
- Development happens through numbered, written-first refactor phases
  ...
  [developer guide](../09-developer-guide/) — read the
  [shared-memory mutex stall](../09-developer-guide/postmortem-shmtx-semaphore-stall.md)
...
[Monitoring Guide](../08-metrics-monitoring/monitoring-guide.md) and
[Operations Guide](../05-operations/operations-guide.md).
...
ledger lives in [Gaps vs Official XRootD](../10-reference/gaps-vs-xrootd.md)
and the [comparison](../10-reference/design-rationale.md). If you need
...
| Zero → verified server | ~50 minutes ([start here](../index.md#-i-want-a-working-server---start-here)) |
...
- **"I've never touched XRootD or built from source."** →
  [Before You Start](before-you-start.md), then
  [What Is This Project?](what-is-this.md)
- **"Give me a running server."** →
  [Getting Started (Full)](getting-started-full.md)
- **"I run a site and want this in production."** →
  [Production Deployment](../03-configuration/production-deployment.md) and the
  [Security Hardening Guide](../07-security/hardening-guide.md)
- **"I think in diagrams."** →
  [Architecture Overview](../11-architecture/overview.md)
- **"I want to contribute."** →
  [Development Workflow](../09-developer-guide/dev-workflow.md),
  [Coding Standards](../09-developer-guide/coding-standards.md), and
  [AGENTS.md](../../AGENTS.md)
- **Everything else** → [docs/index.md](../index.md), the guided map.
