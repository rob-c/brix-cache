...
| dashboard / SRR (`src/observability/dashboard/`, `src/srr/`) | admin-auth HTTP/JSON endpoints, `openat2 RESOLVE_BENEATH` confinement | precedent to reuse for transport + auth |
