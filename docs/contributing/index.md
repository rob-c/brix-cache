...
This document covers the tasks a contributor is most likely to need:
adding an opcode, adding a directive, understanding the code style,
meeting the test bar for a pull request, adding a WebDAV method, and
