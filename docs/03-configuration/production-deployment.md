...
Step-by-step instructions for deploying nginx-xrootd in production — covering systemd service setup, resource limits, log rotation, and the Kubernetes testing pipeline.
...
## Step 5: Deploy nginx-xrootd Servers
