...
The complete X.509 certificate stack used by BriX-Cache, and how it's consumed during authentication over `root://` (XRootD native) and `https://` (WebDAV). If you already know Grid PKI and just want directives, jump to the configuration section.
