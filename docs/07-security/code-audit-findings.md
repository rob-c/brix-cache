# nginx-xrootd Code-Level Security Audit
...
- Other nginx-xrootd instances on the same cluster's management network
...
nginx-xrootd uses `ngx_palloc` (pool allocation) for per-request data and a separate
...
*Code review and implementation: nginx-xrootd main branch, 2026-05-20.*
