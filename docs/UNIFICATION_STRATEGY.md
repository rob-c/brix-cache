...
|:---|:---|:---|:---|:---|
| 1 | [PHASE1_RESOLVER_IMPLEMENTATION.md](PHASE1_RESOLVER_IMPLEMENTATION.md) | Unified path resolver (`src/path/unified.c`) | HIGH | 8–12 h |
| 2 | [PHASE2_IDENTITY_ABSTRACTION.md](PHASE2_IDENTITY_ABSTRACTION.md) | Single `xrootd_identity_t` for GSI/Token/SSS/SigV4 | HIGH | 10–14 h |
| 3 | [PHASE3_VFS_OPERATIONS.md](PHASE3_VFS_OPERATIONS.md) | `src/fs/` VFS layer — open/read/write/stat/dir | CRITICAL | 16–24 h |
| 4 | [PHASE4_CACHE_UNIFICATION.md](PHASE4_CACHE_UNIFICATION.md) | Transparent cache for all three protocols | HIGH | 12–16 h |
| 5 | [PHASE5_TPC_UNIFICATION.md](PHASE5_TPC_UNIFICATION.md) | Shared TPC credential/auth/registry | HIGH | 14–20 h |
| 6 | [PHASE6_METRICS_OBSERVABILITY.md](PHASE6_METRICS_OBSERVABILITY.md) | Op-centric metrics, unified access log, dashboard | MEDIUM | 8–12 h |
