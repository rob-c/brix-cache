# Local Changelog Archive — 12 May 2026

> **ARCHIVED:** This is a local development changelog tracking changes relative to `origin/main` (rob-c/nginx-xrootd). Not user-facing documentation. For release notes, see the project's version history or [Feature Roadmap](../09-developer-guide/feature-roadmap.md).
