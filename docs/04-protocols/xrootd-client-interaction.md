...
It is intentionally higher-level than [operations.md](../05-operations/operations-guide.md) and
[protocol-notes.md](../10-reference/protocol-notes.md). The goal here is to answer "what does
...
- [operations.md](../05-operations/operations-guide.md) - opcode and method reference
- [tls.md](../03-configuration/tls-config.md) - transport and auth layering
- [webdav.md](webdav-overview.md) - HTTPS/WebDAV configuration
- [protocol-notes.md](../10-reference/protocol-notes.md) - low-level wire quirks
- [quirks.md](../10-reference/quirks.md) - design trade-offs and implementation compromises
