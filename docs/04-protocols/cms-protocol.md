...
directions, and the non-obvious details that make BriX-Cache
...
A managed XRootD cluster has three actors. BriX-Cache can play any of them,
...
BriX-Cache implements two independent halves of this, in two source trees:
...
> **The historical bug (now fixed).** BriX-Cache's first login attempt encoded
