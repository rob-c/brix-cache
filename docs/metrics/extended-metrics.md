# Extended Metrics — Protocol Separation, IP Version, VO, and User Tracking

This document covers additional high-level monitoring counters for traffic analysis by protocol, IP version, virtual organisation, and unique user identity. These metrics use bounded tables to prevent cardinality explosion while preserving analytical value.
