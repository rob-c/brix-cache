# TPC implementation: nginx-xrootd vs official xrootd

This document summarizes the concrete differences between nginx-xrootd's
TPC support and the official XRootD project's TPC implementation, and
