...
| `nginx_compat.py` | build and test stock AlmaLinux 9 nginx, 1.28.3 and the current upstream mainline in isolated trees; retain version/hash reports and check incremental builds. Run by `.github/workflows/nginx-compat.yml`; see repo-root `BUILD.md` §6 | — | — |
